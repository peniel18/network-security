...
class ModelTrainer: 
    ...
    def track_mlflow(self, best_model, classificationmetric):
        mlflow.set_registry_uri("https://dagshub.com/peniel18/network-security.mlflow")
    ...
    def train_model(self, X_train, y_train, X_test, y_test):
        ...
        model_trainer_artifact = ModelTrainerArtifact(
            train_metric_artficat=classification_train_metric,
            trained_mode_file_path=self.model_trainer_config.trained_model_file_path, 
